      ...
      <div className="fd-accordion" style={{ marginTop: 16 }}>
        ...
        {methodOpen && (
          <div className="fd-accordion-body">
            ...
            <p>The tool flags anything more than 20% off your trailing 3-period median (three 90-day windows). That's roughly where multiple marketing dashboard frameworks draw the line between normal noise and something worth a second look, including a CMO dashboard variance framework that codes under 10% as normal, 10 to 20% as worth a look, and over 20% as flag-worthy. Some teams reserve 30%+ for severe, drop-everything alerts; 20% surfaces directional signal earlier, in line with this tool's goal of narrowing possibilities rather than waiting for certainty.</p>
