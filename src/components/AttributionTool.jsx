...
const CH_RATES = {
  LinkedIn:     { l2mql: 0.35, mql2opp: 0.22, opp2close: 0.24, cycle: 120 },
  "Google Ads": { l2mql: 0.38, mql2opp: 0.25, opp2close: 0.28, cycle: 65 },
  G2:           { l2mql: 0.40, mql2opp: 0.28, opp2close: 0.30, cycle: 55 },
  Programmatic: { l2mql: 0.04, mql2opp: 0.03, opp2close: 0.05, cycle: 150 },
};
const CH_SEN_DIST = {
...
const SEN_DEAL = {
  c_suite_vp: { label:"C-Suite / VP", track:"Sales-assisted", avgDeal:32000, cycle:105, color:"#2563EB" },
  director:   { label:"Director",     track:"Sales-assisted", avgDeal:24000, cycle:85,  color:"#1D9E75" },
