...
These are my notes/recordings from setting up a new Google Ads account, recorded step by step as I worked through it, then organized with Claude into something a marketer could follow. Google documents most of the individual settings. What is harder to find is the order they go in, and the handful of failures that produce no error message at all. You can either leverage the manual by itself or share it with your LLM and ask it to provide with the steps, so it can help you troubleshoot on the spot in case you miss any of them.
